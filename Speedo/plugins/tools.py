...
@speedo.on(Speedo_cmd(pattern="scan ?(.*)"))
@speedo.on(sudo_cmd(pattern="scan ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@speedo.on(Speedo_cmd(pattern=r"decode$", outgoing=True))
@speedo.on(sudo_cmd(pattern=r"decode$", allow_sudo=True))
...
@speedo.on(Speedo_cmd(pattern="barcode ?(.*)"))
@speedo.on(sudo_cmd(pattern="barcode ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@speedo.on(Speedo_cmd(pattern=r"makeqr(?: |$)([\s\S]*)", outgoing=True))
@speedo.on(sudo_cmd(pattern=r"makeqr(?: |$)([\s\S]*)", allow_sudo=True))
...
@speedo.on(Speedo_cmd(pattern="cal (.*)"))
@speedo.on(sudo_cmd(pattern="cal (.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    start = datetime.datetime.now()
...
@speedo.on(Speedo_cmd(pattern="currency (.*)"))
@speedo.on(sudo_cmd(pattern="currency (.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    input_str = event.pattern_match.group(1)
...
@speedo.on(Speedo_cmd(pattern="currencies$"))
@speedo.on(sudo_cmd(pattern="currencies$", allow_sudo=True))
...
@speedo.on(Speedo_cmd(pattern="ifsc (.*)"))
@speedo.on(sudo_cmd(pattern="ifsc (.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    input_str = event.pattern_match.group(1)
...
@speedo.on(Speedo_cmd(pattern="color (.*)"))
@speedo.on(sudo_cmd(pattern="color (.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    input_str = event.pattern_match.group(1)
...
@speedo.on(Speedo_cmd(pattern="xkcd ?(.*)"))
@speedo.on(sudo_cmd(pattern="xkcd ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@speedo.on(Speedo_cmd(pattern="dns (.*)", outgoing=True))
@speedo.on(sudo_cmd(pattern="dns (.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    input_str = event.pattern_match.group(1)
...
@speedo.on(Speedo_cmd(pattern="url (.*)", outgoing=True))
@speedo.on(sudo_cmd(pattern="url (.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    input_str = event.pattern_match.group(1)
...
@speedo.on(Speedo_cmd(pattern="unshort (.*)", outgoing=True))
@speedo.on(sudo_cmd(pattern="unshort (.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    input_str = event.pattern_match.group(1)

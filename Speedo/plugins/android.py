...
@speedo.on(Speedo_cmd(pattern=r"magisk"))
@speedo.on(sudo_cmd(pattern=r"magisk", allow_sudo=True))
async def _(magisk):
    if magisk.fwd_from:
        return
...
@speedo.on(Speedo_cmd(outgoing=True, pattern=r"device(?: |$)(\S*)"))
@speedo.on(sudo_cmd(pattern=r"device(?: |$)(\S*)", allow_sudo=True))
...
@speedo.on(Speedo_cmd(outgoing=True, pattern=r"codename(?: |)([\S]*)(?: |)([\s\S]*)"))
@speedo.on(sudo_cmd(pattern=r"codename(?: |)([\S]*)(?: |)([\s\S]*)", allow_sudo=True))
...
@speedo.on(Speedo_cmd(outgoing=True, pattern=r"specs(?: |)([\S]*)(?: |)([\s\S]*)"))
@speedo.on(sudo_cmd(pattern=r"specs(?: |)([\S]*)(?: |)([\s\S]*)", allow_sudo=True))
...
@speedo.on(Speedo_cmd(outgoing=True, pattern=r"twrp(?: |$)(\S*)"))
@speedo.on(sudo_cmd(pattern=r"twrp(?: |$)(\S*)", allow_sudo=True))
